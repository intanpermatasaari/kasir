                ...
                <div class="col-sm-10">
                    <select class="form-select @error('produk_id') is-invalid @enderror" id="produk_id" name="produk_id"
                        ...
                        @foreach ($produks as $produk)
                            @if (old('produk_id', $pembelian_detail->produk_id) == $produk->id)
                                <option value="{{ $produk->id }}" data-harga-beli="{{ $produk->harga_beli }}" selected>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control @error('qty') is-invalid @enderror" id="qty"
                        name="qty" value="{{ old('qty', $pembelian_detail->qty) }}" oninput="val()">
                    @error('qty')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control @error('harga_beli') is-invalid @enderror" id="harga_beli"
                        name="harga_beli" value="{{ old('harga_beli', $pembelian_detail->harga_beli) }}" readonly>
                    @error('harga_beli')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>

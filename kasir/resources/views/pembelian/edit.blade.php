                    ...
                    <div class="col-sm-10">
                        <select class="form-select @error('toko_id') is-invalid @enderror" id="toko_id" name="toko_id">
                            ...
                            @foreach ($tokos as $toko)
                                @if (old('toko_id', $pembelian->toko_id) == $toko->id)
                ...
                <div class="col-sm-10">
                    <select class="form-select @error('suplier_id') is-invalid @enderror" id="suplier_id" name="suplier_id">
                        ...
                        @foreach ($supliers as $suplier)
                            @if (old('suplier_id', $pembelian->suplier_id) == $suplier->id)
            ...
            {{-- <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control @error('total') is-invalid @enderror" id="total"
                        name="total" value="{{ old('total', $pembelian->total) }}">
                    @error('total')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control @error('bayar') is-invalid @enderror" id="bayar"
                        name="bayar" value="{{ old('bayar', $pembelian->bayar) }}">
                    @error('bayar')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control @error('sisa') is-invalid @enderror" id="sisa"
                        name="sisa" value="{{ old('sisa', $pembelian->sisa) }}">
                    @error('sisa')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <textarea type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                        name="keterangan">{{ old('keterangan', $pembelian->keterangan) }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
